      ...
      <div className="productcategory">
        ...
        <div className="category">
          <Link to="/kidswears" style={{ textDecoration: "none" }}>
            ...
            <div className="overlay1">Kids Wears</div>
          </Link>
        </div>
      </div>
    </div>
