            ...
            <Navbar bg="dark" variant="dark" style={{ height: "60px" }}>
                <Container>
                    ...
                    <Nav className="me-auto">
                        ...
                        <NavLink to="/SignIn" className="text-decoration-none text-light">Login</NavLink>
                        <NavLink to="/SignUp" className="text-decoration-none text-light mx-3">Register</NavLink>
                        <NavLink to="/Category" className="text-decoration-none text-light mx-3">Category</NavLink>
                ...
                >
                    {
                        getdata.length ?
                            <div className='cart_details' style={{ width: "34rem", padding: 10 }}>
                                <Table>
                                    <thead>
                                        <tr>
                                            <th>ProductImage</th>
