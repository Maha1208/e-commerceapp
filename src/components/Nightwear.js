...
import KidsCardsData from './KidsCardsData';
...
const Girlset = () => {
  ...
  const [data, setData] = useState(KidsCardsData.NightwearProductItems);
  ...
  return (
    <>
      ...
      <div className='container mt-3'>
        <h2 className='text-center'>Kurtas Collections</h2>
